        ...
        <div class="m-3">
            ...
            <div class="d-flex j-between m-2 a-center">
                <div class="d-flex a-center">
                    ...
                    <div class="btn"></div>
                    <button type="button" class="btn-add main-color-hover py-1 px-2" data-bs-toggle="modal" data-bs-target="#addModal">
                        Tambah rekam medis
                    </button>
                </div>
            </div>
                                            ...
                                            <form action="{{ route('rekam_medis.update', $rm->id) }}" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="obat_id[]" class="form h4 f-normal px-2 w-100 h-3 border-radius-1" id="obat_id"
                                                                multiple>
            ...
            <!-- Add Modal -->
            <div class="modal animate__animated" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        @if (auth()->user()->hasRole('admin'))
                            <div class="modal-header">
                        ...
                        <form action="{{ route('rekam_medis.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form h4 f-normal px-2 w-100 h-3 border-radius-1" id="diagnosa" name="diagnosa"
                                            value="{{ old('diagnosa') }}">
                                    </div>
                                    @error('diagnosa')
                                        <p style="color: red">{{ $message }}</p>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form h4 f-normal px-2 w-100 h-3 border-radius-1" id="tindakan" name="tindakan"
                                            value="{{ old('tindakan') }}">
                                    </div>
                                    @error('tindakan')
                                        <p style="color: red">{{ $message }}</p>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="obat_id[]" id="obat_id" class="form h4 f-normal px-2 w-100 h-3 border-radius-1" multiple>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="peralatan_id[]" id="peralatan_id" class="form h4 f-normal px-2 w-100 h-3 border-radius-1"
                                            multiple>
                                ...
                                <div id="image-container">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" class="form h4 f-normal px-2 w-100 h-3 border-radius-1" id="image" name="images[]"
                                                multiple>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="px-2 py-1 btn-close red-hover" data-bs-dismiss="modal">Close</button>
