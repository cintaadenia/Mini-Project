                    ...
                    <form action="{{ route('obat.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="resep_id" id="resep_id" class="form-control">
                                        ...
                                        <option value="{{$res->id}}">{{$res->kunjungan->pasien->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('resep_id')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_obat" name="nama_obat" value="{{ old('nama_obat') }}">
                                </div>
                                @error('nama_obat')
                                    <script>
                                        Swal.fire('Error', '{{$message}}', 'error');
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal{{ $obt->id }}">
                            Edit
                        </button>
                    </td>
                </tr>
                ...
                <!-- Edit Modal -->
                <div class="modal fade" id="editModal{{ $obt->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $obt->id }}" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form action="{{ route('obat.update',$obt->id) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="resep_id" id="resep_id" class="form-control">
                                                <option value="{{$obt->resep->kunjungan_id}}">{{$obt->resep->kunjungan->pasien->nama}}</option>
                                                @foreach ($resep as $res)
                                                <option value="{{$res->id}}">{{$res->kunjungan->pasien->nama}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="Jumlah" class="col-sm-2 col-form-label">Jumlah</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="jumlah" name="jumlah" value="{{ $obt->jumlah }}">
                                        </div>
                                        @error('jumlah')
                                            <script>
                                                Swal.fire('Error', '{{$message}}', 'error');
                                    ...
                                    <div class="mb-3 row">
                                        <label for="dosis" class="col-sm-2 col-form-label">Dosis</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="dosis" name="dosis" value="{{ $obt->dosis }}">
                                        </div>
                                        @error('dosis')
                                            <script>
                                                Swal.fire('Error', '{{$message}}', 'error');
